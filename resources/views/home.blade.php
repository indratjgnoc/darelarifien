...
@section('description')
    Website resmi Pesantren {{ $settings['school_name'] ?? '' }}. Informasi pendidikan, program, kegiatan dan pendaftaran
    santri.
@endsection
                        ...
                        <div
                            ...
                            @if (!empty($settings['logo']))
                                <img src="{{ asset('storage/' . $settings['logo']) }}"
                                    ...
                                    class="h-40 w-40 rounded-xl object-contain">
                            @else
                                <div
            ...
            <div>
                ...
                <div class="mt-8
                    ...
                    <div class="rounded-2xl
                        ...
                        <i data-lucide="book-open" class="h-7 w-7
                               text-[#087443]"></i>
                    ...
                    <div class="rounded-2xl
                        ...
                        <i data-lucide="heart-handshake" class="h-7 w-7
                               text-[#087443]"></i>
...
========================================================= --}}
    ...
    <section id="program" class="bg-[#F5F7F6]">
