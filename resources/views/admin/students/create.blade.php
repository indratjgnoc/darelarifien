            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Tambahkan data santri baru ke dalam sistem akademik.
                    </p>
                </div>
            ...
            <div class="rounded-3xl bg-white p-6
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="nisn" value="{{ old('nisn') }}" placeholder="Contoh: 0012345678"
                            class="w-full rounded-xl border border-gray-200
                               bg-gray-50 px-4 py-3 text-sm
                               outline-none transition
                               focus:border-[#087443]
            ...
            <div class="rounded-3xl bg-white p-6
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="4" placeholder="Alamat lengkap santri"
                            class="w-full resize-none rounded-xl border
                               border-gray-200 bg-gray-50 px-4 py-3
                               text-sm outline-none transition
                               focus:border-[#087443]
                               focus:bg-white
                               focus:ring-2 focus:ring-[#087443]/10">{{ old('address') }}</textarea>
            ...
            <div class="rounded-3xl bg-white p-6
                ...
                <div class="mb-6 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-400">
                            Tentukan tahun ajaran dan kelas santri.
                        </p>
                    </div>
