...
<div class="max-w-4xl">
        ...
        <div class="mt-5 flex items-start gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Perbarui informasi dan pengaturan tahun ajaran.
                </p>
            </div>
    ...
    ========================================================== --}}
    <form
        action="{{ route('admin.academic-years.update', ['academic_year' => $academicYear->id]) }}"
        method="POST"
    >
                ...
                <div class="grid gap-6 p-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option
                                value="Ganjil"
                                @selected(old('semester', $academicYear->semester) === 'Ganjil')
                            >
                                Ganjil
                            </option>
                            ...
                            <option
                                value="Genap"
                                @selected(old('semester', $academicYear->semester) === 'Genap')
                            >
                                Genap
                            </option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows="4"
                            placeholder="Masukkan keterangan tahun ajaran..."
                            class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-[#087443] focus:bg-white focus:ring-2 focus:ring-[#087443]/10"
                ...
                <div class="space-y-5 p-6">
                    ...
                    >
                        ...
                        <span>
                            ...
                            <span class="mt-1 block text-xs leading-relaxed text-gray-500">
                                Jadikan tahun ajaran ini sebagai tahun ajaran yang sedang aktif.
                    ...
                    >
                        ...
                        <input
                            ...
                            value="1"
                            @checked(old('course_selection_open', $academicYear->course_selection_open))
                            class="mt-1 h-5 w-5 rounded border-gray-300 text-[#087443] focus:ring-[#087443]"
                        >
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs leading-relaxed text-blue-700">
                            Tahun ajaran aktif akan menjadi periode akademik utama
                            yang digunakan oleh sistem pesantren.
                        </p>
