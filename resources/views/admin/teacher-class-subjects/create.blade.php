...
<div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm leading-6 text-gray-500">
                    Tentukan guru, kelas, mata pelajaran, dan tahun akademik untuk penugasan mengajar.
                </p>
            </div>
    ...
    {{-- Form --}}
    <form action="{{ route('admin.teacher-class-subjects.store') }}"
          method="POST">
        ...
        <div class="grid grid-cols-1 gap-6 xl:grid-cols-3">
                    ...
                    <div class="space-y-6 p-6">
                            ...
                            <select id="academic_year_id"
                                ...
                                @foreach($academicYears as $academicYear)
                                    <option value="{{ $academicYear->id }}"
                                        {{ old('academic_year_id', $activeAcademicYear?->id) == $academicYear->id ? 'selected' : '' }}>
                                        {{ $academicYear->name }}
                        ...
                        <div>
                            ...
                            <textarea id="description"
                                      ...
                                      class="w-full rounded-xl border-gray-200 bg-gray-50 px-4 py-3 text-sm text-gray-700 outline-none transition placeholder:text-gray-400 focus:border-[#087443] focus:bg-white focus:ring-2 focus:ring-[#087443]/10">{{ old('description') }}</textarea>
            ...
            <div class="space-y-6">
                ...
                {{-- Informasi --}}
                <div class="rounded-2xl bg-[#062E1F] p-6 text-white shadow-sm">
                    ...
                    <div class="mt-5 space-y-4 text-sm leading-6 text-white/70">

                        <div class="flex gap-3">
                            <i data-lucide="check" class="mt-1 h-4 w-4 shrink-0 text-emerald-400"></i>

                            <p>
                                Satu guru dapat mengajar beberapa kelas dan mata pelajaran.
                            </p>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <p>
                                Penugasan yang sama tidak dapat dibuat dua kali.
                            </p>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <p>
                                Pastikan tahun akademik dan kelas sudah sesuai.
                            </p>
                        </div>
