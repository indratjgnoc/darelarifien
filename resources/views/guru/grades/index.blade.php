...
<div class="space-y-6">
    ...
    @if (session('success'))
        ...
        <div class="flex items-center gap-3 rounded-xl border border-emerald-200
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200
        ...
        <div class="border-b border-slate-100 p-6">
            ...
            <p class="mt-1 text-sm text-slate-500">
                Nilai yang sebelumnya sudah dimasukkan untuk mata pelajaran ini.
            </p>
                        ...
                        @foreach ($grades as $index => $grade)
                            ...
                            <tr class="transition hover:bg-slate-50">
                                ...
                                <td class="px-5 py-4">
                                    ...
                                    <span class="inline-flex min-w-14
        ...
        @else
            ...
            <div class="p-10 text-center">
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Nilai yang sudah disimpan akan muncul di sini.
                </p>
